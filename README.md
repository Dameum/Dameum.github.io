...
```
.
├── index.html                        https://dameum.github.io/
├── app-ads.txt                       https://dameum.github.io/app-ads.txt
└── tap-pop-ai/
    └── privacy/
        └── index.html                https://dameum.github.io/tap-pop-ai/privacy/
```
...
| 용도 | URL | 쓰이는 곳 |
|---|---|---|
| 개인정보처리방침 | `https://dameum.github.io/tap-pop-ai/privacy/` | Play Console > 앱 콘텐츠 |
| 개발자 웹사이트 | `https://dameum.github.io/` | Play Console > 스토어 등록정보 |
| app-ads.txt | `https://dameum.github.io/app-ads.txt` | AdMob 광고 단가 인증 |
